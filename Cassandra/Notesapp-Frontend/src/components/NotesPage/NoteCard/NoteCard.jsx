import {
  ...
  export default function NoteCard({ title, body, user, _id }) {
    ...
    return (
      <Card backgroundColor={"rgba(0, 200, 20, 0.3)"}>
        <CardBody>
          <VStack>
            <Heading fontFamily={"'Nanum Myeongjo', serif"} fontSize={"1.5em"}>{title}</Heading>
            <Text fontFamily={"Google Sans"} fontSize={"1.5em"} >{body}</Text>
